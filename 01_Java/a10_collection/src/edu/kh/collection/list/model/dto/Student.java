...
public class Student implements Comparable<Student>{
	...
	// A.equals(b) : A 객체와 B 객체가 가지고 있는 필드의 값이 모두 같다면 True, 아니라면 False
	// Object.equals() 오버 라이딩
...
//	
	...
	public boolean equals(Object obj) {
		...
		// 서로 다른 Student와 Student를 비교해야 하므로 obj를 
		// Student로 다운 캐스팅하는 과정을 거쳐야 한다.
		Student other = (Student)obj;
		
		// 현재 객체(this와 다른 객체(other)의 필드를 비교
	...
	public int hashCode() {
		return Objects.hash(grade, ban, number, gender, score);
	}
