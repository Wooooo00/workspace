package edu.kh.jdbc.model.model.dto;
...
public class Member { 
	...
	private String memberTel; // JAVA와 DB의 Char 구분하기
	...
	// 게터, 세터 자동완성 alt + shift + s -> getter/setter generate
	...
	// Object.toString() 오버라이딩 alt + shift + s then s
