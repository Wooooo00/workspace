...
-- 900, '장채현', '901123-2345678', 'jang_ch@kh.or.kr', '01012341234','D1', 'J7',
-- 'S3', 4300000, 0.2, 200, SYSDATE, NULL, 'N'

INSERT INTO EMPLOYEE2 
VALUES(900, '장채현', '901123-2345678', 'jang_ch@kh.or.kr', '01012341234','D1', 'J7',
 'S3', 4300000, 0.2, 200, SYSDATE, NULL, 'N');
...
VALUES (데이터값)
테이블에 선택한 컬럼에 대한 값만 INSERT 할 때 사용한다.
선택 안 된 컬럼은 값에 NULL이 들어감
*/
...
INSERT INTO EMP_01
-- VALUSE -- 서브쿼리로 INSERT하는 경우에는 VALUES 생략
...
-- 여러 컬럼을 수정할 때 콤마로 컬럼을 구분
/* UPDATE DEPARTMENT2
 * SET DEPT_ID = 'D9', DEPT_TITLE = '전략기획2팀'
 * WHERE DEPT_ID = 'D9'
 * 
 */
...
유재식의 급여, 보너스를 조회 -> 방명수 급여, 보너스를 유재식과 같게 수정해줌
